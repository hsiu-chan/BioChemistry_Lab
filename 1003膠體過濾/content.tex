...
\begin{enumerate}
  ...
  \item 運用的材料為Sephadex G50，名稱來自separation Pharmacia dextran，是一種葡聚醣凝膠，常用於凝膠過濾柱中，G後面的數字代表小珠的大小，因此可以視需要分離的分子大小選擇不同的Sephadex。\upcite{Wikipedia_2023_Sephadex}
...
\begin{enumerate}[label=\arabic*.]
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    \item 取八支eppendorf，分別放入BSA 0,2,4,6,8,10μl及Unknown1:2μl Unknown2:4μl溶於\ce{ddH2O}至最終容量為10μg。
    \begin{table}[ht]
      \centering
      \begin{tabular}{ccc}
      \toprule
